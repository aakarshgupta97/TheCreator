...
if("TRUE" STREQUAL "TRUE")
  set(reflex_visualizer2_SOURCE_PREFIX /home/cc/ee106a/fa18/class/ee106a-aab/ros_workspaces/TheCreator/src/reflex-ros-pkg/reflex_visualizer2)
  set(reflex_visualizer2_DEVEL_PREFIX /home/cc/ee106a/fa18/class/ee106a-aab/ros_workspaces/TheCreator/devel)
  ...
  set(reflex_visualizer2_INSTALL_PREFIX /home/cc/ee106a/fa18/class/ee106a-aab/ros_workspaces/TheCreator/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'reflex_visualizer2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Right Hand Robotics <reflex-support@righthandrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'reflex_visualizer2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa18/class/ee106a-aab/ros_workspaces/TheCreator/src/reflex-ros-pkg/reflex_visualizer2/${idir}'.  Ask the maintainer 'Right Hand Robotics <reflex-support@righthandrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${reflex_visualizer2_dep}_FOUND)
      find_package(${reflex_visualizer2_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${reflex_visualizer2_dep} REQUIRED ${depend_list})
  endif()
