...
def main():
    ...
    # orien_consts.append(orien_const)

    # Add a box obstacle
    # box_size = [0.6, 0.1, 0.6]
    # box_name = "box"
    ...
    while not rospy.is_shutdown():
        ...
        while not rospy.is_shutdown():
            try:
                ...
                plan = planner.plan_to_pose(goal_1, orien_consts)
        ...
        while not rospy.is_shutdown():
            try:
                ...
                plan = planner.plan_to_pose(goal_2, orien_consts)
        ...
        while not rospy.is_shutdown():
            try:
                ...
                plan = planner.plan_to_pose(goal_3, orien_consts)
