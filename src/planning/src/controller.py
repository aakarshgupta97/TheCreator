...
class Controller(object):
    ...
    def step_control(self, t):
        ...
        delTime = t - self._LastTime
        self._IntPos = self._IntPos + delTime * error
        derivError = (error - self._LastError) / delTime
        self._LastError = error
        self._LastTime = t
        print("target position:", target_position)
        print("current position:", current_position)
        print("deltime:", delTime)
        print("Kp:", self._Kp * error)
        print("Ki:", self._IntPos * self._Ki)
        print("Kd:", derivError * self._Kd)

        u = error * self._Kp + self._IntPos * self._Ki + derivError * self._Kd
